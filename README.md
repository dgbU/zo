<h1><picture>
  <source media="(prefers-color-scheme: dark)" srcset="./lib/assets/Zologowhite.png.svg?raw=true">
  <source media="(prefers-color-scheme: light)" srcset="./lib/assets/Zologo.png?raw=true">
  <img alt="Zo" src="./lib/assets/Zologo.png?raw=true" height="100">
</picture></h1>
